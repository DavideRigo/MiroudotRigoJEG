* =============================================================================
* This do file replicates Table B2
* =============================================================================
...
ppml_panel_sg fa_outgood rta pta_y*, ex(par) im(cou) y(year) 
outreg2 using "$home/output/results/tableB2", ///
replace text addtext(Host-year FE, YES, Partner-year FE, YES, Country-pair FE, YES) label cttop("GOOD")

ppml_panel_sg fa_outgood rta inv_prov pta_y*, ex(par) im(cou) y(year) 
outreg2 using "$home/output/results/tableB2", ///
...
ppml_panel_sg fa_outserv rta pta_y*, ex(par) im(cou) y(year) 
outreg2 using "$home/output/results/tableB2", ///
append text addtext(Host-year FE, YES, Partner-year FE, YES, Country-pair FE, YES) label cttop("SERV")

ppml_panel_sg fa_outserv rta inv_prov pta_y*, ex(par) im(cou) y(year) 
outreg2 using "$home/output/results/tableB2", ///
